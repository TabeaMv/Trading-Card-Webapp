<template>
    <div class="p-1 items-center justify-center">
        ...
        <NuxtImg :src="'https://d2c66v0b507n0b.cloudfront.net/' + encodedID + '_Basic.png'" :alt="player.id" class="thumb"></NuxtImg>
        </NuxtLink>
    </div>
</template>
...
<script setup>
    ...
    const encodedID = encodeURIComponent(player.id); // make sure that spaced get swapped for %20 etc.
</script>
